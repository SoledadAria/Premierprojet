...
json_arrivees <- fromJSON("https://674a5f5b-2d4c-4bfb-a025-e344ef6765fc@api.sncf.com/v1/coverage/sncf/stop_areas/stop_area:SNCF:87212027/arrivals?count=1000&")
View(json_arrivees)
